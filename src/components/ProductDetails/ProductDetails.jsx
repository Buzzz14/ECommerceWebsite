                ...
                <section className='grid grid-cols-1 lg:grid-cols-2  gap-x-8 gap-y-10 px-4 pt-10'>
                    ...
                    <div className="lg:col-span-1 max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
                        <div className="lg:col-span-2">
                            <h1 className="text-lg lg:text-xl font-semibold text-gray-900 ">Lorem, ipsum dolor.</h1>
                            <h1 className='text-lg lg:text-xl text-gray-900 opacity-60 pt-1'>Lorem ipsum dolor sit amet consectetur.</h1>
                        </div>
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className="mt-6">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <p className='opacity-50 text-sm'>455 Ratings</p>
                                    <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500 cursor-pointer'>2566 Reviews</p>
                                </div>
                            </div>
                            ...
                            <form className="mt-10">
                                ...
                                <Button variant='contained' sx={{ px: '2rem', py: '1rem', mt: '2rem', bgcolor: deepPurple[500] }}>Add to cart</Button>
                            </form>
                        </div>
                        ...
                        <Grid container spacing={7}>
                            ...
                            <Grid size={5}>
                                ...
                                <div className='flex item-center space-x-3'>
                                    ...
                                    <p className='opacity-60 '>4531616 Ratings</p>
                                </div>
